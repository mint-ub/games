...
var ASM_CONSTS = {
 ...
 1477927: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 1478010: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 1478079: () => { return window.innerWidth; },  
 1478109: () => { return window.innerHeight; },  
 1478140: ($0, $1) => { alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1)); }
};
